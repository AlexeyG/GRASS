...
${OBJECTDIR}/GAIndividual.o: GAIndividual.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/GAIndividual.o GAIndividual.cpp

${OBJECTDIR}/ExtendedFixedMIQPSolver.o: ExtendedFixedMIQPSolver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/ExtendedFixedMIQPSolver.o ExtendedFixedMIQPSolver.cpp

${OBJECTDIR}/EMSolver.o: EMSolver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/EMSolver.o EMSolver.cpp

${OBJECTDIR}/DPGraph.o: DPGraph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/DPGraph.o DPGraph.cpp

${OBJECTDIR}/SolverConfiguration.o: SolverConfiguration.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/SolverConfiguration.o SolverConfiguration.cpp

${OBJECTDIR}/MIQPSolver.o: MIQPSolver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/MIQPSolver.o MIQPSolver.cpp

${OBJECTDIR}/FixedMIQPSolver.o: FixedMIQPSolver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/FixedMIQPSolver.o FixedMIQPSolver.cpp
...
${OBJECTDIR}/RelaxedFixedMIQPSolver.o: RelaxedFixedMIQPSolver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/RelaxedFixedMIQPSolver.o RelaxedFixedMIQPSolver.cpp

${OBJECTDIR}/GAMatrix.o: GAMatrix.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/GAMatrix.o GAMatrix.cpp

${OBJECTDIR}/BranchAndBound.o: BranchAndBound.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/BranchAndBound.o BranchAndBound.cpp

${OBJECTDIR}/optimizer.o: optimizer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/optimizer.o optimizer.cpp

${OBJECTDIR}/ScaffoldExtractor.o: ScaffoldExtractor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/ScaffoldExtractor.o ScaffoldExtractor.cpp

${OBJECTDIR}/ScaffoldComparer.o: ScaffoldComparer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/ScaffoldComparer.o ScaffoldComparer.cpp

${OBJECTDIR}/DPSolver.o: DPSolver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/DPSolver.o DPSolver.cpp

${OBJECTDIR}/GASolver.o: GASolver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/GASolver.o GASolver.cpp

${OBJECTDIR}/GraphViz.o: GraphViz.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/GraphViz.o GraphViz.cpp

${OBJECTDIR}/RandomizedGreedyInitializer.o: RandomizedGreedyInitializer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/RandomizedGreedyInitializer.o RandomizedGreedyInitializer.cpp

${OBJECTDIR}/IterativeSolver.o: IterativeSolver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/IterativeSolver.o IterativeSolver.cpp

${OBJECTDIR}/ScaffoldConverter.o: ScaffoldConverter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/ScaffoldConverter.o ScaffoldConverter.cpp

${OBJECTDIR}/Solver.o: Solver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Common -MMD -MP -MF $@.d -o ${OBJECTDIR}/Solver.o Solver.cpp
